...
<%
	...
	String update_del="update gtm_nonuser_charge set save_time="+save_time+",save_admin='"+true_name+"' where charge_id="+charge_id;
	String to_del="insert into gtm_nonuser_charge_del select * from gtm_nonuser_charge where charge_id="+charge_id;
	String sql="delete from gtm_nonuser_charge where charge_id="+charge_id;
