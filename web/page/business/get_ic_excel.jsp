...
<%	
	...
	String get_dtotal_sql="select ct.charge_type_name,sum(fc.charge_amount),ct.charge_type_id from GTM_MAINFORM_INFO gmf join gtm_front_charge_new fc on fc.username=gmf.username and fc.charge_date>=to_date('"+startDate+" 00:00:00','yyyy-mm-dd hh24:mi:ss') and fc.charge_date<=to_date('"+endDate+" 23:59:59','yyyy-mm-dd hh24:mi:ss') right join gtm_charge_type ct on fc.charge_type_id=ct.charge_type_id group by ct.charge_type_name,ct.charge_type_id order by ct.charge_type_id";
