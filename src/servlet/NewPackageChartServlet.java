 ...
 */
public class NewPackageChartServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for(int i=0;i<pack.size();i++){
            String packName = pack.get(i).get("QUOTA").toString();
            long packCount = service.getPackageCount(Tools.concat(params,new Object[]{packName}));
            sb.append("{")
                    .append("\"name\":\""+new String(packName.getBytes("ISO-8859-1"),"GBK")+"\",")
                    .append("\"data1\":"+packCount+",")
                    .append("},");
        }
        if(sb.length()>2){
